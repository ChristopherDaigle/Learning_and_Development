...
with open("binary2", 'br') as bin_file:
    ...
    print(h)
    i = int.from_bytes(bin_file.read(4), 'big') # Wrote in little indian format, but read in big indian
                                                # format, it doesn't allow us to read it as we wrote it
                                                # if we don't indicate the same method for reading as was
                                                # used for writing
    print(i)
