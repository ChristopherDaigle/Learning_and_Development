...
class Album:
    ...
    Attributes:
        ...
        artist (Artist): The artist responsible for the album
            If not specified, the artists will default to an artist with the name
            "Various Artists"
...
class Artist:
    ...
    Attributes:
        ...
        albums (List[Album]): A list of the albums by this artist
            ...
            not an exhausitive list of the artist's published albums
    ...
    def add_album(self, album):
        ...
        Args:
            album (Album): Album object to add to the list
                If the album is already present, it will not be added again (although
...
#
#         Args:
#             :param (str): Initializes the 'title' attribute
#             :param (Artist): An Artist object representing the song's creator
#             :param (Optional[int]): Initial value for the 'duration' attribute
#                 Will default to zero if not specified
#         """
# help(Song)
# help(Album)
...
def load_data():
    ...
    with open("albums.txt", "r") as albums:
        ...
        # We will have an artist and album that haven't been stored - process them now
...
if __name__ == '__main__':
    artists = load_data()
    print('There are {} artists in the file.'.format(len(artists)))
