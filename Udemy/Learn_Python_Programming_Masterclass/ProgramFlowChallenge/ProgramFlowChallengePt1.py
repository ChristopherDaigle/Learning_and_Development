...
and prints out the number segments it contains, and the length of each segment.
...
number of segments and long each one is.
...
for char in ipAddress:
    if char == '.':
        ...
        segment_length += 1
# # Unless the final character in the string was a dot, we haven't printed the last segment
# if char != '.':
#     print('Segment {} contains {} characters.'.format(segment, segment_length))
...
#
# if ipAddress == '':
#     print('You have not entered an IP Address.')
# else:
#     for char in ipAddress:
#         if char == '.':
#             print('Segment {} is {} long.'.format(segments, lengths))
#             segments += 1
#             lengths = 0
#         else:
#             lengths += 1
